...
- (void)_updatePageLayout
{
	...
	for(SCSafariPageWrapperViewController *wrapper in self.pageViewController.loadedViewControllers) {
		...
		CATransform3D transform = [self.zoomedOutLayouter sublayerTransformForPageWithFrame:frame totalNumberOfPages:numberOfPages contentOffset:self.pageViewController.scrollView.contentOffset];
