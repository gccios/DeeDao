...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        UIView *contentV = [[UIView alloc] initWithFrame:CGRectMake(0, kMainBoundsHeight, kMainBoundsWidth, 220)];
        ...
        self.titleL = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(cancelButton.frame), 0, kMainBoundsWidth-104, 40)];
        ...
        //分割线
        UIView *splitView = [[UIView alloc] initWithFrame:CGRectMake(0, 40, kMainBoundsWidth, 0.5)];
...
{
    UILabel*label=[[UILabel alloc]initWithFrame:CGRectMake(kMainBoundsWidth*component/6.0, 0,kMainBoundsWidth/6.0, 30)];
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    ...
    self.currentTime = [DDTool DDGetDoubleWithYear:selectedYear month:selectedMonth day:selectedDay hour:selectedHour minute:selectedMinute];
}
...
- (void)showDateTimePickerView{
    ...
    [UIView animateWithDuration:0.25f animations:^{
        self.alpha = 1;
        _contentV.frame = CGRectMake(0, kMainBoundsHeight-220, kMainBoundsWidth, 220);
...
- (void)hideDateTimePickerView{
    ...
    [UIView animateWithDuration:0.2f animations:^{
        self.alpha = 0;
        _contentV.frame = CGRectMake(0, kMainBoundsHeight, kMainBoundsWidth, 220);
    } completion:^(BOOL finished) {
        self.frame = CGRectMake(0, kMainBoundsHeight, kMainBoundsWidth, kMainBoundsHeight);
    }];
