...
- (void)createViews
{
    ...
    UIView * codeLeftView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 270 * scale, 144 * scale)];
    UILabel * codeLeftLabel = [DDViewFactoryTool createLabelWithFrame:CGRectMake(0, 0, 250 * scale, 144 * scale) font:kPingFangRegular(42 * scale) textColor:UIColorFromRGB(0x000000) alignment:NSTextAlignmentRight];
    ...
    self.passwordField.placeholder = @"请设置当前账号密码";
    
    UIView * passwordLeftView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 270 * scale, 144 * scale)];
    UILabel * passwordLabel = [DDViewFactoryTool createLabelWithFrame:CGRectMake(0, 0, 250 * scale, 144 * scale) font:kPingFangRegular(42 * scale) textColor:UIColorFromRGB(0x000000) alignment:NSTextAlignmentRight];
    passwordLabel.text = @"账户密码:";
    ...
    self.secondPasseordField.placeholder = @"请再次输入密码";
    
    UIView * secondLeftView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 270 * scale, 144 * scale)];
    UILabel * secondLeftLabel = [DDViewFactoryTool createLabelWithFrame:CGRectMake(0, 0, 250 * scale, 144 * scale) font:kPingFangRegular(42 * scale) textColor:UIColorFromRGB(0x000000) alignment:NSTextAlignmentRight];
    secondLeftLabel.text = @"密码确认:";
